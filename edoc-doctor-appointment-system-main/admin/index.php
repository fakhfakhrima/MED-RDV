...
<body>
    ...
    <tr class="menu-row">
                    <td class="menu-btn menu-icon-secretary">
            ...
            <tr>
                ...
                <td colspan="2" class="nav-bar">
                    ...
                    <form action="doctors.php" method="post" class="header-search">
                        ...
                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Doctor or secretary by name or Email" list="doctors">&nbsp;&nbsp;
                ...
                <td width="15%">
                    ...
                    <p class="heading-sub12" style="padding: 0;margin: 0;">
                        ...
                        $newsec = $database->query("select  * from  job;");
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <td style="width: 25%;">
                                    <div class="dashboard-items" style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div>
                                            <div class="h1-dashboard">
                                                <?php echo $newsec->num_rows  ?>
                                            </div><br>
                                            <div class="h3-dashboard">
                                               <a style="text-decoration: none; color:black;" href="./formJob/listsec.php"> New Secratary</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </div>
                                        </div>
                                        <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/doctors-hover.svg');"></div>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                    Upcoming Appointments next <?php
